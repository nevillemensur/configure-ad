...
2. Create the Client VM (Windows 10) named “Client-1”. Use the same Resource Group and Vnet that was created in Step 1.Set Domain Controller’s NIC Private IP address to be static
